...
<form action="${pageContext.request.contextPath}/job/updateByIdJobOffer" method="POST">  
 <h1 class="title1">Update JobOffer</h1>
  <div class="inline-p1"> 
        <p><label for="IdJobOffer">ID Job Offer:</label></p>
        <input type="number" id="IdJobOffer" name="IdJobOffer" value="<%=request.getParameter("idJobOffer")%>" readonly></div>
<div class="inline-p1">
        <p><label for="title">Title:</label></p>
        <input type="text" id="title" name="title" value="<%=jobOffer.getTitle()%>"></div>
<div class="inline-p1">
         <p><label for="description">Description:</label></p>
        <input type="text" id="description" name="description" value="<%=jobOffer.getDescription()%>"></div>
  <div class="inline-p1">  
         <p><label for="startDate">Start Date:</label></p>
        <input type="date" id="startDate" name="startDate" value="<%=jobOffer.getStartDate()%>"></div>
 <div class="inline-p1">  
        <p> <label for="endDate">End Date:</label></p>
        <input type="date" id="endDate" name="endDate" value="<%=jobOffer.getEndDate()%>"></div>
   <div class="inline-p1"> 
         <p><label for="idCompanyClient">ID Company Client:</label></p>
   ...
   <div class="inline-p1">
        <p> <label for="minRal">Min Ral:</label></p>
        <input type="number" id="minRal" name="minRal" value="<%=jobOffer.getMinRal()%>"></div>
   <div class="inline-p1"> 
        <p> <label for="maxRal">Max Ral:</label></p>
        <input type="number" id="maxRal" name="maxRal" value="<%=jobOffer.getMaxRal()%>"></div>
   <div class="inline-p1"> 
        <p> <label for="idContractType">ID Contract Type:</label> </p>
