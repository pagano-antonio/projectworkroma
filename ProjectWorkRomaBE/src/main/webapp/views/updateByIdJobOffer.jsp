	...
	<div class="container1">
		<div class="card1">
			...
			<form
				...
				<div class="inline-p1">
					<p>
						<label for="IdJobOffer">Job Offer ID:</label>
					</p>
				...
				<div class="inline-p1">
					...
					<select name="idCompanyClient">
						<c:forEach var="listIdCompanyClient"
							...
							<option value="${listIdCompanyClient.idCompanyClient}">${listIdCompanyClient.name}
				...
				<div class="inline-p1">
					...
					<select name="idContractType">
						<c:forEach var="listIdContractType" items="${listIdContractType}">
							<option value="${listIdContractType.idContractType}">${listIdContractType.title}
