...
<form class="formFind" action="${pageContext.request.contextPath}/company/findByIdCompanyClient" method="GET">
		<p><label for="idCompanyClient">Id Company Client:</label></p>
		<input class="inputField" type="number" id="idCompanyClient" name="idCompanyClient">
<div>
