	...
	<div class="card">
		<div class="boxFind">
			...
			<form class="formFind"
				...
				method="GET">
				<p>
					<label for="cityCompanyClient">City:</label>
				</p>
				<input class="inputField" type="text" id="cityCompanyClient"
					name="cityCompanyClient">
				<div>
		...
		<div class="boxTitle">
			...
			<img class="imageLogin"
				src="resources/css/Immagini/ricerca.gif" alt="ricerca"
