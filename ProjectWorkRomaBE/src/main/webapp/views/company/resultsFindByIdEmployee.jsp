...
<table>
    ...
    <tbody>
        <c:forEach var="idEmployee" items="${idEmployee}">
    <tr>
        <td>${idEmployee.idEmployee}</td>
        <td>${idEmployee.getEmployeeType().getIdEmployeeType()}</td>
        <td>${idEmployee.name}</td>
        <td>${idEmployee.surname}</td>
        <td>${idEmployee.email}</td>
        <td>${idEmployee.password}</td>
        <td>${idEmployee.username}</td> 
        <td>
