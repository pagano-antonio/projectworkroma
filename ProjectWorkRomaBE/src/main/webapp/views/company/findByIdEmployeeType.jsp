...
<div class="container">
    ...
    <span>FIND EMPLOYEE TYPE ID</span>
</div>
<form action="${pageContext.request.contextPath}/company/findByIdEmployeeType" method="GET">  
    <div class="data-group">
        <label for="title">ID Employee Type:</label>
        <input type="text" id="idEmployeeType" name="idEmployeeType">
    </div>
    <div class="submit">
