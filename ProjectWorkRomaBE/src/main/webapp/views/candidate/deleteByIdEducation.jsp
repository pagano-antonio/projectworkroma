...
<title>Delete By Id Education</title>
</head>
<body>
<div class="container">
    ...
    <span>DELETE BY ID EDUCATION</span>
</div>
<form action="${pageContext.request.contextPath}/candidate/deleteByIdEducation" method="GET">  
