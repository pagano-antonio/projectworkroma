...
<body>
	<div class="card">
		<div class="boxFind">
			<p class="findTitle">Find Candidate by phone number</p>
			<form class="formFind"
				action="${pageContext.request.contextPath}/candidate/findByPhoneCandidate"
				method="GET">
				<p>
					<label for="phone">Phone:</label>
				</p>
				<input class="inputField"  type="text" id="phone" name="phone">
