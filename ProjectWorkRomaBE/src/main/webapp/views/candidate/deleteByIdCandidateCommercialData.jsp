...
<head>   
  <meta charset="UTF-8">
  <title>Delete by Id Candidate Commercial Data</title>
...
<form action="${pageContext.request.contextPath}/candidate/deleteByIdCandidateCommercialData" method="GET">  
    <div class="data-group">
        <label for="idCandidateCommercialData">ID Candidate Commercial Data:</label>
