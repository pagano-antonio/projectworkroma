...
<title>Find Job Offer By Max Ral</title>
...
<body>
	...
	<div class="card">
		<div class="boxFind">
			...
			<form class="formFind"
				action="${pageContext.request.contextPath}/job/findByMaxRalJobOffer"
				method="GET">
				<p>
					<label for="maxRal">Maximum RAL:</label>
				</p>
				<input class="inputField" type="text" id="maxRal" name="maxRal">
		<div>
