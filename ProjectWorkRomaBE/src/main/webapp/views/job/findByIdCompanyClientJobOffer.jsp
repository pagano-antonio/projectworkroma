...
<div class="container">
    ...
    <span>FIND ID COMPANY CLIENT JOB OFFER</span>
</div>
<form action="${pageContext.request.contextPath}/job/findByIdCompanyClientJobOffer" method="GET">  
    <div class="data-group">
        <label for="title">ID Company Client:</label>
        <input type="text" id="idCompanyClient" name="idCompanyClient">
    </div>
    <div class="submit">
