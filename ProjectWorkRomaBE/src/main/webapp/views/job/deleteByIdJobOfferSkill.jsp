...
<div class="container">
	...
	<form
		action="${pageContext.request.contextPath}/job/deleteByIdJobOfferSkill"
		method="GET">
		<table>
			<td>ID Job Offer Skill:</td>
			<th><input type="number" id="idJobOfferSkill" name="idJobOfferSkill"></th>
		</table>
		<table>
			<tr>
				<h4>Select:</h4>
