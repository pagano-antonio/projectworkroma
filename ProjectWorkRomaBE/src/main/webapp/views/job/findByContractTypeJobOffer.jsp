...
<title>Find Job Offer by Contract Type</title>
...
<div class="card">
		<div class="boxFind">
			...
			<form class="formFind" action="${pageContext.request.contextPath}/job/findByContractTypeJobOffer" method="GET">  
    <p>
        <label for="title">Contract Type:</label></p>
