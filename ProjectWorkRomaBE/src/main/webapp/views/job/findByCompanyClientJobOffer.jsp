...
<title>Find Job Offer By Company CLient</title>
...
<div class="card">
		<div class="boxFind">
			...
			<form class="formFind" action="${pageContext.request.contextPath}/job/findByCompanyClientJobOffer" method="GET">  
   <p>
        <label for="name">Company Client:</label></p>
        <input class="inputField" type="text" id="name" name="name" placeholder="Insert name Company">
  	<div>
