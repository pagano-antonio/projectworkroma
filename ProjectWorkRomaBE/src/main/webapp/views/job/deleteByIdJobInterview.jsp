...
<title>Delete by Id Job Interview</title>
...
<div class="container">
    ...
    <span>DELETE BY ID JOB INTERVIEW</span>
</div>
	<form
		action="${pageContext.request.contextPath}/job/deleteByIdJobInterview"
		method="GET">
		<table>
			<td>ID Job Interview:</td>
			<th><input type="number" id="idJobInterview" name="idJobInterview"></th>
		</table>
		<table>
			<tr>
				<h4>Select:</h4>
