...
<form action="${pageContext.request.contextPath}/job/findByMinRalJobOffer" method="GET">  
    <div class="data-group">
        <label for="minRal">Minimum RAL:</label>
        <input type="text" id="minRal" name="minRal">
    </div>
    <div class="submit">
